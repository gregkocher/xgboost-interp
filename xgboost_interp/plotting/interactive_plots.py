...
class InteractivePlotter(BasePlotter):
    ...
    def _build_tree_data(self, tree: Dict, feature_names: List[str], 
                        y_shift: float = 0) -> Tuple[List, List, List, List, List, int]:
        """
        ...
        Returns:
            tuple: (edge_x, edge_y, node_x, node_y, node_text, max_depth)
        """
        import networkx as nx
        ...
        return edge_x, edge_y, node_x, node_y, node_text, max_depth[0]
    ...
    def _create_tree_plot(self, tree: Dict, feature_names: List[str], tree_idx: int):
        ...
        edge_x, edge_y, node_x, node_y, node_text, max_depth = self._build_tree_data(
            tree, feature_names
        )
    ...
    def _add_tree_to_figure(self, fig, tree: Dict, feature_names: List[str],
        ...
        edge_x, edge_y, node_x, node_y, node_text, _ = self._build_tree_data(
